...
%% Generate matrix A
paraFPPA.RecLev = L;
% [RecMat,Recmat_norm2] = GenerateRecMat(paraFPPA);
load RecMat;

%% Choose parameter in FPPA algorithm
paraFPPA.TargetTSLs = [512,118,120,300,500,650,800,1600,2000,8400];     %  targeted sparsity levels
paraFPPA.TargetSL = sum(paraFPPA.TargetTSLs);
paraFPPA.MaxIter = 2000;
paraFPPA.rho = 0.01;
paraFPPA.alpha = 1/(Recmat_norm2^2)/paraFPPA.rho*0.99;  % convergence condition
